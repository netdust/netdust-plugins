...
**Status:** spec, revision 1 (Cluster A gate 2026-08-23: FR-3's anonymous-form clause corrected — `->public()` on a POST is refused by core, the route hands over a callable) — revision 0 written 2026-08-23 from the brainstorm of the same
