...
- [ ] T01 — ntdst-framework SKILL.md + traps.md rewritten as the v5 contract [Tier B]  (files: skills/ntdst-framework/SKILL.md, skills/ntdst-framework/references/traps.md, skills/ntdst-framework/lessons.md)
...
- [ ] T02 — the three golden paths on the v5 doors [Tier B]  (files: skills/ntdst-patterns/golden-paths/form-data-flow.md, skills/ntdst-patterns/golden-paths/content-type-feature.md, skills/ntdst-patterns/golden-paths/admin-settings-page.md)
  Satisfies: FR-3, SC-5
...
- [ ] T04 — wp-security's NTDST section and wp-plan-requirements' drift example on v5 [Tier B]  (files: skills/wp-security/SKILL.md, skills/wp-plan-requirements/SKILL.md)
  ...
  Proven by: machine gate — `grep -c "api_data\|Actions.php\|verifyOrigin\|Origin\`/\`Referer" skills/wp-security/SKILL.md` = 0; `grep -c "ntdst_rest\|X-WP-Nonce\|->public()\|allowed_http_origins" skills/wp-security/SKILL.md` ≥ 4; `grep -c "api_data" skills/wp-plan-requirements/SKILL.md` = 0
