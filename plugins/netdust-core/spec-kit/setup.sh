...
#
# Decision (ADR 2026-06-17): the OVERRIDE templates are BUNDLED in netdust-core (this dir);
...
#
# Usage:
#   plugins/netdust-core/spec-kit/setup.sh [PROJECT_ROOT]   # defaults to $PWD
#
# Env overrides:
...
if [ ! -f "$CONST" ]; then
  cat > "$CONST" <<'EOF'
<!-- PLACEHOLDER — run the netdust-core:constitution-bridge skill to generate this file
