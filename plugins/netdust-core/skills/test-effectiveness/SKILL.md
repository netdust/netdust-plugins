...
3. **Sweep siblings.** Every `blind` finding on a cross-cutting concern (a guard with twins, a canonical form with many consumers, a predicate at N sites) gets a sibling-site sweep — modes 1, 4, and 5 almost always have ≥1 sibling the primary fix missed.
