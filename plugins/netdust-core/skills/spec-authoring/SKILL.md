...
| `netdust-core:spec-analysis` | **DOWNSTREAM (Stage 1.5).** Cross-checks the Security-relevant surfaces flags against the plan's threat model. |
| `netdust-core:harnessed-development` | **SEQUENCER.** Inserts this as Stage 0.5 (Phase C edit). |
