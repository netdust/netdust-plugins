#!/usr/bin/env python3
"""
pretooluse-guard.py — netdust-core harness
...
Purpose:
  Every other netdust-core guardrail is post-hoc (SubagentStop catches "you
...
def main() -> None:
    ...
    label, matched = hit
    reason = (
        f"netdust-core guard: this command matches a destructive pattern "
