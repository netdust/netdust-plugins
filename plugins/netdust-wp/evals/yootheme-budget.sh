...
# before any work started. This gate holds the load at ≤ 45,000 and each router
...
if [ "$load" -le 45000 ]; then echo "ok    page-build load = $load B (≤ 45000)"; else echo "OVER  page-build load = $load B (> 45000)"; fail=1; fi
