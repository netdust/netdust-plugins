...
Governing reference: **`ntdst-architecture/golden-paths/feature-service.md`** (service lifecycle), **`netdust-wp:wp-security`** (the save's four pillars). This doc shows the settings-specific shape.
...
- Governing references: `ntdst-architecture/golden-paths/feature-service.md`, `netdust-wp:wp-security` (the save's four pillars).
