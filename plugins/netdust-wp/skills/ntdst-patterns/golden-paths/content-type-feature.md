...
Governing reference: **`ntdst-framework/SKILL.md`** (service lifecycle), **`ntdst-framework/SKILL.md`** (Data API + repository contract). This doc does not restate those rules — it shows the shape they produce.
...
- Governing references: `ntdst-framework/SKILL.md`, `.../pages.md`, `ntdst-framework/SKILL.md`.
