...
(`core/Bootstrap.php`, `core/Container.php`, `core/Router.php`, `api/Response.php`), and against live
consumers `daan-core/services/musician/CardService.php` and `daan-core/services/admin/AdminUIService.php`.
...
```php
// Slug comes from the CLASS NAME: BookingService -> `booking`.
// Renaming metadata()['name'] does NOT rename any of these.
