...
| `architecture-invariants` | **PASS A CROSS-REF.** CODE-MAP entries for convergence points name the invariant. A spec that added a convergence point updates both. |
