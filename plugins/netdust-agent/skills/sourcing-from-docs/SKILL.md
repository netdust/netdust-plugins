...
<integration>
- **`planning` / `building` (any stage)** — reach for this skill the moment an external-behavior claim becomes load-bearing in plan, execute, or debug. Cross-cutting, not tied to one stage.
