...
| **C — Bug-fix bundle from /code-review or /security-review** | `building` directly — one TDD cycle per finding; if any finding touches a security boundary, the 1a diff threat model first |
