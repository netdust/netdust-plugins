...
- **Never `[P]`.** Integration-contract tasks share one `wptests` DB whose schema is reinstalled per run; serialize them (the same constraint the plan records).
