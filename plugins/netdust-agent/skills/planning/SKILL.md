...
4. User-facing work carries an `## Acceptance flows` matrix with mandatory per-flow edges (1g), and the plan carries a readable `## Stakes` line the downstream gates scale against (1i).
